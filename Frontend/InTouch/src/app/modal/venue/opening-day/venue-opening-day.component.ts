...
@Component({
    ...
    selector: 'app-venue-opening-day',
    templateUrl: './venue-opening-day.component.html',
...
export class VenueOpeningDayPage implements OnInit {
    ...
    public deleteOpeningDate(isOrderBy: number) {
        ...
        this.openingDayEdit.forEach(item => {
            if (item.idDay === isOrderBy) {
                ...
                resetOpeningDay.venue = item.venue
