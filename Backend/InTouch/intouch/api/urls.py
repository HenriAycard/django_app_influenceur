...
urlpatterns = [
    ...
    path('influencer/', InfluencerListView.as_view(), name='influencer_list'),
    ...
    path('influencer/<uuid:pk>', InfluencerDetailView.as_view(), name='influencer_detail'),
    ...
    path('offer/<int:pk>/duplicate', OfferDuplicateView.as_view(), name='offer_duplicate'),
